...
single player word generator, n dictionary api word fetch
*/
...
function getRandomWord() {
  return fetchRandomWord()
    .then(data => {
        aRandomWord = data.word;
        definition = data.meanings[0]?.definitions[0]?.definition || 'No definition available';
      //console.log('Random Word:', aRandomWord);
      //console.log('Definition:', definition);
      wordGenerator();
      //return { aRandomWord, definition };
    });
